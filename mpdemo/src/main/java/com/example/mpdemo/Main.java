...
import com.example.mpdemo.utils.MyUtils;
...
public class Main {
    ...
    public static void main(String[] args) {
        Translator<Image, DetectedObjects> translator = YoloV5Translator.builder().optSynsetArtifactName("names").build();
        Criteria<Image, DetectedObjects> criteria =
                Criteria.builder()
                        .setTypes(Image.class, DetectedObjects.class)
                        .optDevice(Device.cpu())
                        .optModelUrls("src/main/resources/yolov5")
                        .optModelName("best_clothes.torchscript.pt")
...
//                        .build();
    ...
    static void detect(Mat frame, ZooModel<Image, DetectedObjects> model) throws IOException, ModelNotFoundException, MalformedModelException, TranslateException {
        Image img = (Image) MyUtils.mat2Image(frame);
